...
PROJECT_DIRECTORY = '/home/poetrycam/poetry-camera-rpi-v4' # SET TO YOUR OWN PROJECT DIRECTORY -- DO NOT INCLUDE END SLASH
...
def initialize():
  ...
  # Set up printer
  global printer
  BAUD_RATE = 19200 # REPLACE WITH YOUR OWN BAUD RATE
  ...
  global knob1, knob2, knob3, knob4
  knob1 = Button(17)
  knob2 = Button(27)
  knob3 = Button(22)
  knob4 = Button(5)

  # knob button event handlers
  knob1.when_pressed = get_poem_format
  knob2.when_pressed = get_poem_format
  knob3.when_pressed = get_poem_format
  knob4.when_pressed = get_poem_format
...
def print_footer():
  ...
  printer.println('This build by: @maker_chad')
  printer.println('Original build by: @poetry.camera')
  printer.println('\n\n\n\n\n\n\n\n\n\n')
  printer.println('\n\n\n\n\n\n')
#  printer.println('\n\n\n\n\n\n')
...
def on_release():
  ...
  elif duration > 2 and duration < 9: #if user presses button a little longer
    print("pressing the button a little more worked")
...
def get_poem_format():
  global poem_format
  # poem_format = '8 line free verse. Do not rhyme. DO NOT EXCEED 8 LINES.'

  if knob1.is_pressed:
    poem_format = 'limerick. DO NOT EXCEED 5 LINES.'
  elif knob2.is_pressed:
    poem_format = '8 line free verse. Do not rhyme. DO NOT EXCEED 4 LINES.'
##    poem_format = 'haiku. You must match the 5 syllable, 7 syllable, 5 syllable format. It must not rhyme'
  elif knob3.is_pressed:
    poem_format = 'limerick in Spanish. DO NOT EXCEED 5 LINES.'
  elif knob4.is_pressed:
    poem_format = '8 line free verse poem in Spanish. Do not exceed 8 lines.'
